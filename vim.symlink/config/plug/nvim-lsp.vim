...
lua << EOF
  ...
  local on_attach = function(client, bufnr)
   ...
   -- buf_set_keymap("n", '<leader>f', "<cmd>lua vim.lsp.buf.formatting()<CR>", opt--s)
  end
  ...
  nvim_lsp.tsserver.setup {
    ...
    on_attach = function(client, bufnr)
      ...
      -- TODO: Research https://github.com/tomaskallup/dotfiles/blob/master/nvim/lu--a/plugins/lsp-ts-utils.lua
